...
const Header = () => {
  ...
  return (
    <div className={`py-2 px-2  md:px-8 absolute bg-gradient-to-b from-black w-full z-10 flex justify-between items-center flex-col md:flex-row gap-2 ${user && "border-b-2 border-red-600"} bg-black md:bg-transparent md:border-none`}>
